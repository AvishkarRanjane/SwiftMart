...
export default function Toast() {
  ...
  return (
    <div className="fixed bottom-20 sm:bottom-6 left-1/2 -translate-x-1/2 z-[9999] pointer-events-none transition-all duration-300 animate-bounce-short max-w-[90vw]">
      <div
